...
const tonePrompts = {
  ...
  casual: "Write a short reply to this tweet, using a friendly and upbeat tone. Message: '{text}'. Author: {accountName}. Exclude hashtags, emojis, and mentions. Language: {lang}. Response length: {length}. Gender-neutral language only. Don't use Interjections like Wow, Huh, Thanks, etc.",
