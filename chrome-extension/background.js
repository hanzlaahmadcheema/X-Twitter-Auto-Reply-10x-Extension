    ...
    chrome.storage.sync.get(
      ...
      async (data) => {
        ...
        if (selectedModel === "gemini") {
          ...
          payload = {
            messages: [
              { role: "system", content: "You are Grok, a witty chatbot." },
...
const tonePrompts = {
  ...
  straightforward: "Compose a direct and straightforward reply to '{text}' from {accountName}. Use clear language without unnecessary elaboration. Ensure the response is gender-neutral, in {lang}, and avoids hashtags, emojis, and interjections such as 'Wow' or 'Huh'. Stick to a length of {length}.",
