...
const tonePrompts = {
  ...
  professional: "Craft a reply to this tweet in a professional, respectful manner. Text: '{text}'. Author: {accountName}. Exclude hashtags, emojis, and mentions. Language: {lang}. Response length: {length}. Gender-neutral language only. Don't use Interjections like Wow, Huh, etc.",
  humorous: "Reply to this tweet with a humorous touch. Text: '{text}'. Author: {accountName}. No hashtags, emojis, or mentions. Language: {lang}. Length: {length}. Keep it gender-neutral. Don't use Interjections like Wow, Huh, etc.",
  ...
  witty: "Write a clever, concise reply to this tweet with a bit of humor. Text: '{text}'. Author: {accountName}. No hashtags, emojis, or mentions. Language: {lang}. Length: {length}. Keep it gender-neutral. Don't use Interjections like Wow, Huh, etc."
};
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (message.action === "generateReply") {
    ...
    // Retrieve the appropriate prompt template for the selected tone
    ...
    fetch(apiUrl, {
      ...
      .then(data => {
        // Check if response from 'openai' provider exists and extract text
